# Plan: Amanuensis → Rust GPUI dictation app
...
| `asr_s`/`load_s` timing events | structured pipeline logging to stderr + `amanuensis.log` (RTF, RMS/peak, paste trace, focus decisions) | richer and file-persisted |
...
8. Polish: compact square Amanuensis window with hover controls.
